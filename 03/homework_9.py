# Добавьте обработку ошибки 400 (Bad Request) при попытке создать контакт с некорректным email.
...
class ContactCreate(BaseModel):
    ...
    # Именно здесь происходит автоматическая валидация email.
    # При неверном формате Pydantic сразу вернёт ошибку, а FastAPI — 400.
    email: EmailStr
...
def create_contact(contact: ContactCreate):
    # Сюда код доходит только если Pydantic уже успешно проверил все поля.
